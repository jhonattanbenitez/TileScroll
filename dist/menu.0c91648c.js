 ...
 */
{
  ...
  imagesLoaded(document.querySelector('.background'), {
    background: true
  }, function () {
  ...
  var allowTilt = true;
  var tilt = new TiltFx(); // Hovering the github link zooms in the main image.

  var githubEl = document.querySelector('.github');
  githubEl.addEventListener('mouseenter', function () {
    allowTilt = false;
    tilt.zoom();
  });
  githubEl.addEventListener('mouseleave', function () {
    return allowTilt = true;
  });
}
...
},{}]},{},["../../../Users/Desarrollo/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/menu.js"], null)
